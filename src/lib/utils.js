import { GENERATOR_URL, STATIC_ASSETS_URL } from '../constants/env';
 ...
 *
 * @param {string} relativePath - the path withtout `/static/images/`
 */
export const imgUrl = relativePath => {
  return `${STATIC_ASSETS_URL}/images/${relativePath}`;
};
